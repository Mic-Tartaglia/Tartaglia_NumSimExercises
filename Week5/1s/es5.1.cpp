...
int main(){
	...
	double x0[3] = { 1., 0., 0.}; //initial position
	double x[3];	//position

	double L = 1.; //cube size for delta
	...
	ofstream X_out, Y_out, Z_out, R_out;
	...
	cout << endl << "Average acceptance probability: " << a/nsteps;
